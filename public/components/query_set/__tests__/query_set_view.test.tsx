...
const mockUseQuerySetView = require('../hooks/use_query_set_view').useQuerySetView as jest.MockedFunction<any>;
...
describe('QuerySetView', () => {
  ...
  it('renders query set data', () => {
    ...
    expect(container.querySelector('[data-testid="query-set-name"]')?.textContent).toBe('Test Query Set');
  });
