...
import { setupAceAutocomplete } from '../utils/query_autocomplete';
    ...
    return (
      <EuiForm component="form" isInvalid={Boolean(nameError || queryError)}>
        ...
        <EuiFormRow
          ...
          helpText="Define the query in JSON format. Use %SearchText% to represent the specific query text. Autocomplete is available when an index is selected."
          fullWidth
        >
          <EuiCodeEditor
            height="10em"
