...
The Search Relevance Workbench allows uploading manually generated [query sets](https://docs.opensearch.org/latest/search-plugins/search-relevance/query-sets/).
