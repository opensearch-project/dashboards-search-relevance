...
* Add /srw slash command for chatbot to navigate to Search Relevance Workbench ([#843](https://github.com/opensearch-project/dashboards-search-relevance/pull/843))
