...
* Add autocomplete suggestions for Query DSL keywords and index field names in the Search Configuration query editor. ([#794](https://github.com/opensearch-project/dashboards-search-relevance/pull/794))
